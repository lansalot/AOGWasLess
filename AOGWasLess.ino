...
// Modified by Desmartins Daniel 15/06/2024
// version wasless activation par IBT2
// debug sur BT
// code BricBric

// Version Engage CAN aprouved 5.7.2 08 Feb 2023
...
uint8_t DEBUGrxbuffer[serial_buffer_size]; // Extra serial rx buffer
uint8_t DEBUGtxbuffer[serial_buffer_size]; // Extra serial tx buffer
...
void setup()
{
    ...
    delay(10);
    Serial.println("Firmware : AutoSteer GPS Teensy Engage CAN for PCB Compact !");
    ...
    SerialDebug->addMemoryForRead(DEBUGrxbuffer, serial_buffer_size);
    SerialDebug->addMemoryForWrite(DEBUGtxbuffer, serial_buffer_size);
    Serial.println("DebugSerial BT initialized");
    SerialDebug->println("Firmware : AutoSteer GPS Teensy Engage CAN for PCB Compact !");
    SerialDebug->print("Version : ");
    SerialDebug->println(VERSION);
    SerialDebug->println("DebugSerial BT initialized");
